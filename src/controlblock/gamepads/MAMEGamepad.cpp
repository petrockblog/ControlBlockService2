...
void MAMEGamepad::update()
{
    ...
    if ((channel == InputDevice::CHANNEL_1) || (channel == InputDevice::CHANNEL_3))
    {
        ...
        keyboard->setKeyState(KEY_LEFT,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P1_LEFT, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
        keyboard->setKeyState(KEY_RIGHT,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P1_RIGHT, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
        ...
        keyboard->setKeyState(KEY_DOWN,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P1_DOWN, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
        ...
        keyboard->setKeyState(KEY_1,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P1_START, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
    ...
    else if ((channel == InputDevice::CHANNEL_2) || (channel == InputDevice::CHANNEL_4))
    {
        ...
        keyboard->setKeyState(KEY_D,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P2_LEFT, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
        keyboard->setKeyState(KEY_G,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P2_RIGHT, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
        ...
        keyboard->setKeyState(KEY_F,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P2_DOWN, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
        ...
        keyboard->setKeyState(KEY_2,
                digitalIn->getLevel(IDigitalIn::DI_CHANNEL_P2_START, boardIn) == IDigitalIn::DI_LEVEL_LOW ? 0 : 1, EV_KEY);
