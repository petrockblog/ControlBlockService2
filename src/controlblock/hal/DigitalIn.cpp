...
//      bcm2835_gpio_fsel(RPI_GPIO_P1_12, BCM2835_GPIO_FSEL_INPT);
    ...
    case DI_DEVICE_GENESIS:
      ...
      break;
    default:std::cout << "DigitalIn: Unknown device type" << std::endl;
      throw 50;
  }
}
...
//      returnLevel = bcm2835_gpio_lev(RPI_GPIO_P1_12) == LOW ? DI_LEVEL_LOW : DI_LEVEL_HIGH;
    ...
    case DI_CHANNEL_P1_LEFT:
      returnLevel = expander[0 + offset]->digitalRead(1) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_UP:
      returnLevel = expander[0 + offset]->digitalRead(2) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_DOWN:
      returnLevel = expander[0 + offset]->digitalRead(3) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW1:
      returnLevel = expander[0 + offset]->digitalRead(4) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW2:
      returnLevel = expander[0 + offset]->digitalRead(5) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW3:
      returnLevel = expander[0 + offset]->digitalRead(6) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW4:
      returnLevel = expander[0 + offset]->digitalRead(7) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW5:
      returnLevel = expander[1 + offset]->digitalRead(0) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW6:
      returnLevel = expander[1 + offset]->digitalRead(1) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW7:
      returnLevel = expander[1 + offset]->digitalRead(2) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_SW8:
      returnLevel = expander[1 + offset]->digitalRead(3) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    ...
    case DI_CHANNEL_P1_COIN:
      returnLevel = expander[1 + offset]->digitalRead(5) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_A:
      returnLevel = expander[1 + offset]->digitalRead(6) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P1_B:
      returnLevel = expander[1 + offset]->digitalRead(7) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    ...
    case DI_CHANNEL_P2_UP:
      returnLevel = expander[0 + offset]->digitalRead(13) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                    : DI_LEVEL_HIGH;
      break;
    ...
    case DI_CHANNEL_P2_SW1:
      returnLevel = expander[0 + offset]->digitalRead(11) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                    : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_DATA:
    case DI_CHANNEL_P2_SW2:
      returnLevel = expander[0 + offset]->digitalRead(10) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                    : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_SW3:
      returnLevel = expander[0 + offset]->digitalRead(9) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_SW4:
      returnLevel = expander[0 + offset]->digitalRead(8) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_SW5:
      returnLevel = expander[1 + offset]->digitalRead(15) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                    : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_SW6:
      returnLevel = expander[1 + offset]->digitalRead(14) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                    : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_SW7:
      returnLevel = expander[1 + offset]->digitalRead(13) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                    : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_SW8:
      returnLevel = expander[1 + offset]->digitalRead(12) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                    : DI_LEVEL_HIGH;
      break;
    ...
    case DI_CHANNEL_P2_A:
      returnLevel = expander[1 + offset]->digitalRead(9) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
    case DI_CHANNEL_P2_B:
      returnLevel = expander[1 + offset]->digitalRead(8) == MCP23S17PI::LEVEL_HIGH ? DI_LEVEL_LOW
                                                                                   : DI_LEVEL_HIGH;
      break;
  }
